-- Run once after 003_enquiry_consent_version.sql before deploying the blog
-- dashboard foundation. This creates the single-admin authentication, session,
-- login-rate-limit, media, taxonomy, post, and redirect tables.
